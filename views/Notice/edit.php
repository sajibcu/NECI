        ...
        <div class="content-container">
            ...
            <div class="portlet">
                <div class="portlet-header">
                    <h3> <i class="fa fa-calendar"></i>Add Notice</h3>
                </div>
                <!-- /.portlet-header -->
                <div class="portlet-content">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                            ...
                            <form role="form" action="../Notice/update.php" method="post">
                                ...
                                <div class="form-group has-default">
                                    ...
                                    <!--                                                <div class="input-group">-->
                                    <!--                                                    <div class="input-group-addon"><i class='fa fa-tint'></i></div>-->
                                    <input type="hidden" id="packagename" name="id" value="<?php echo $notice['id'] ?>" >
                                    <!--                                                </div>-->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date ui-datepicker" data-date-format="yyyy-mm-dd">
                                        <input id="date-2" name="notice_date" value="<?php echo $notice['notice_date']?>" class="form-control" type="text" data-required="true">
                                ...
                                <!--                                                <div class="input-group">-->
                                <!--                                                    <div class="input-group-addon"><i class='fa fa-tint'></i></div>-->
                                <!--                                                    <input type="text" id="packagename" name="notice_date" placeholder="Notice Date"  VALUE="- echo date('Y-m-d')<!--" class="form-control" readonly="readonly">-->
                                <!--                                                </div>-->
                                <!--                                            </div>-->
                                ...
                                <div class="form-group has-default">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class='fa fa-tint'></i></div>
                                        <input type="text" id="packagename" name="notice_title" value="<?php echo $notice['notice_title']?>" class="form-control" required="true">
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-default">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="notice_content" class="form-control" cols="30" rows="10"><?php echo $notice['notice_content']?></textarea>
                                    </div>
                                </div>
